...
if( isset($_POST['submit']) ){
        ...
        if(!empty(trim($name)) && !empty(trim($username)) && !empty(trim($email)) && !empty(trim($password)) && !empty(trim($repass))){
            if($password == $repass){
                if( cek_nama($name,$con) == 0 ){
                    ...
                    $query = "INSERT INTO uts_skd (username,name,email, password ) VALUES ('$username','$name','$email','$pass')";
                    ...
                    if ($result) {
                        ...
                        $error =  'Registerasi user gagal !!';
                    }
                }else{
                        $error =  'Username yang diinputkan sudah terdaftar !!';
                }
            }else{
                $validate = 'Password yang diinputkan tidak sama !!';
            } 
        }else {
    ...
    function cek_nama($username,$con){
        ...
        $query = "SELECT * FROM uts_skd WHERE username = '$nama'";
